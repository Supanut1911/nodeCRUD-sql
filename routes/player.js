...
module.exports = {
    ...
    addPlayer: (req, res)=>{
        ...
        db.query(usernameQuery, (err, result) => {
            ...
            if(result.length > 0) {
                ...
                if (uploadedFile.mimetype === 'image/png' || 'image/jpeg' || 'image/gif') {
                    ...
                    message = "Invalid File format. Only 'png', 'jpeg', 'Gif are allowed.'";
                    res.render('add-player.ejs', {
                        message,
                        title: "welcome to socka | add a new player"
                    })
    ...
    deletePlayer: (req, res) => {
        ...
        // console.log('here >', playerId, getImageQuery)
